...
namespace Project_SLAY.Controllers
{
    public class DisputesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DisputeID,Amount,Status,Comments")] Dispute dispute)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DisputeID,Amount,Status,Comments")] Dispute dispute)
        {
